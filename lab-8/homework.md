...
- ✅ Screenshots/evidence of experiment running
- ✅ Any issues and how you resolved them

#### Raw Data (15 points)
- ✅ Complete dataset (CSV or table)
- ✅ All metrics tracked
...
- ✅ Experiment executed with minimum 10 data points
- ✅ Results documented with basic analysis
- ✅ Decision made (persevere/pivot/iterate)
- ✅ Roadmap updated

### Excellent Work (90-100 points)
- ✅ Exceeds minimum sample size (20+ data points)
...
- ❌ Claiming results without data
- ❌ Ignoring data that contradicts assumptions
- ❌ Vague or generic analysis
- ❌ Decision not based on experiment results
- ❌ No change to roadmap despite learnings
...
2. **Folder structure:**
   ...
   03-build/
   ├── experiments/
   │   ├── hypothesis-prioritization.md (from lab)
   │   ├── experiment-plan.md (from lab)
   │   ├── experiment-logs/
   │   │   └── experiment-01-results.md ← HOMEWORK
   │   ├── experiment-01-analysis.md ← HOMEWORK
   │   ├── pivot-decision-001.md ← HOMEWORK
   │   └── updated-roadmap.md ← HOMEWORK
   └── validation/
       └── ... (from lab)
   ```
...
### Do's
✅ Start experiment early in the week (Monday/Tuesday)
✅ Track data daily - don't wait until the end
✅ Be honest about negative results (they're still learning)
✅ Talk to users, not just collect clicks
✅ Document as you go, not at the end

### Don'ts
❌ Don't fake data or inflate numbers
❌ Don't ignore results that contradict your assumptions
❌ Don't skip the analysis - raw data isn't enough
❌ Don't change experiment mid-way without documenting why
...
✅ Real data about your product assumptions  
✅ Experience running lean experiments  
✅ Practice making evidence-based decisions  
✅ Refined product direction based on learning  
